        ...
        <div className="border-b pb-7 mb-7">
              <div className="flex">
                <div className="w-1/6 flex flex-col items-center">
                  ...
                  <p className="text-center font-bold text-black">{review.first_name+" "+review.last_name}</p>
                </div>
                <div className="ml-10 w-5/6">
                  <div className="flex items-center text-black">
                    <div className="flex font-medium mr-5"><Stars review={[]} rating={review.rating}/></div>
                  </div>
                  <div className="mt-5">
