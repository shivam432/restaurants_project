...
export default async function handler(
  ...
  await prisma.restuarant.deleteMany();
  ...
  await prisma.restuarant.createMany({
    data: [
      // INDIAN //
      {
  ...
  const restaurants = await prisma.restuarant.findMany();
  ...
  await prisma.item.createMany({
    data: [
      ...
      },
      {
        ...
        price: "$12.00",
        restuarant_id: lastTrainToDelhiId,
      },
      {
      ...
      },
      {
        ...
        price: "$18.00",
        restuarant_id: adrakYorkvilleId,
      },
      {
        name: "papad ki tokri",
      ...
      },
      {
        ...
        price: "$32.00",
        restuarant_id: curryishTavernId,
      },
      {
      ...
      },
      {
        ...
        price: "$8.99",
        restuarant_id: kamasutraIndianId,
      },
      {
      ...
      },
      {
        ...
        price: "$24.00",
        restuarant_id: canoRestaurantId,
      },
      {
